...
const FormModalClassmajor = (props) => {
  ...
  let title = "Add Class Major";
  if (props.type === "edit") title = "Edit Class Major";
    ...
    try {
      ...
      if (confirmation.isConfirmed) {
        ...
        if (props.type === "add") {
          ...
          response = await axios.post(config.apiUrl + `/class/major`, payload, {
            headers: {
          ...
          response = await axios.put(
            config.apiUrl + `/class/major/` + props.editId,
            payload,
            {
              headers: {
                authorization: `Bearer ${token}`,
...
FormModalClassmajor.defaultProps = {
  onHide: () => {},
  show: false,
  type: "add",
  initialValues: null,
...
export default FormModalClassmajor;
