...
const FormModalCourse = (props) => {
  ...
  if (props.type === "edit") title = "Edit Course";
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      const payload = _.pick(values, ["name", "level", "type", "semester"]);
      ...
      if (confirmation.isConfirmed) {
        ...
        if (props.type === "add") {
          ...
          response = await axios.post(config.apiUrl + `/course`, payload, {
            headers: {
          ...
          response = await axios.put(
            config.apiUrl + `/course/` + props.editId,
            payload,
            {
              headers: {
                authorization: `Bearer ${token}`,
...
export default FormModalCourse;
